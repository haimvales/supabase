...
--
-- Host: mysql:3306
-- Generation Time: דצמבר 29, 2025 בזמן 10:40 AM
-- גרסת שרת: 8.0.44
-- PHP Version: 8.3.26
...
CREATE TABLE `products` (
  `productCode` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `productName` varchar(70) COLLATE utf8mb4_general_ci NOT NULL,
  `productLine` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `productScale` varchar(10) COLLATE utf8mb4_general_ci NOT NULL,
  `productVendor` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
